...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock,AiFillDatabase } from 'react-icons/ai';
...
import { FaUserSecret,FaUniversalAccess,FaShieldVirus } from "react-icons/fa";
...
export const earningData = [
  ...
  },
  {
    ...
    title: 'Exploits Performed',
    iconColor: 'rgb(235, 52, 52)',
  ...
  },
  {
    ...
    iconColor: 'rgb(94, 94, 209)',
    iconBg: 'rgb(213, 213, 227)',
  },
];
...
export const customersData = [

  {
    ...
    CustomerName: 'Hassaan Oumair',
    CustomerEmail: 'hssaanrandom@gmail.com',
    ProjectName: 'AeroIntruder',
    Status: 'Active',
    CustomerImage:
      avatar,
    StatusBg: '#8BE78B',
...
export const scheduleData = [
  {
    Id: 1,
    Subject: 'Data Breach at Major Corporation',
  ...
  {
    Id: 2,
    Subject: 'Ransomware Attack Report',
    Location: 'San Francisco',
    StartTime: '2024-04-19T10:00:00.000Z',
    EndTime: '2024-04-19T11:30:00.000Z',
    CategoryColor: '#1aaa55',
  },
  {
    Id: 3,
    Subject: 'Cybersecurity Vulnerabilities Workshop',
    Location: 'Space Center USA',
    StartTime: '2024-04-20T08:00:00.000Z',
    EndTime: '2024-04-20T10:00:00.000Z',
    CategoryColor: '#357cd2',
  },
  {
    Id: 4,
    Subject: 'Zero-Day Vulnerability Disclosures',
    Location: 'London',
    StartTime: '2024-04-22T07:30:00.000Z',
    EndTime: '2024-04-22T09:00:00.000Z',
    CategoryColor: '#7fa900',
  },
  {
    Id: 5,
    Subject: 'Phishing Attack Prevention',
    Location: 'Los Angeles',
    StartTime: '2024-04-23T08:30:00.000Z',
    EndTime: '2024-04-23T10:30:00.000Z',
...
export const kanbanData = [
  {
    Id: 'Vuln-001',
    Title: 'Vulnerability - 10001',
    Status: 'Open',
    Summary: 'Analyze the new vulnerabilities found during the scan.',
    Type: 'Security Flaw',
    Severity: 'Low',
    Tags: 'Analysis,Scan',
    Effort: 3.5,
    AssignedTo: 'Nancy Davloio',
    RiskLevel: 1,
    Color: '#02897B',
    ClassName: 'security-flaw, low-severity, nancy-davloio',
  },
  {
    Id: 'Vuln-002',
    Title: 'Vulnerability - 10002',
    Status: 'InProgress',
    Summary: 'Improve security measures to mitigate risks.',
    Type: 'Mitigation',
    Severity: 'Medium',
    Tags: 'Mitigation',
    Effort: 6,
    ...
    RiskLevel: 1,
    Color: '#673AB8',
    ClassName: 'mitigation, medium-severity, andrew-fuller',
  },
  {
    Id: 'Vuln-003',
    Title: 'Vulnerability - 10003',
    Status: 'Open',
    Summary: 'Arrange a meeting with the IT team to discuss new vulnerabilities.',
    Type: 'Meeting',
    Severity: 'High',
    Tags: 'Meeting,IT',
    Effort: 5.5,
    AssignedTo: 'Janet Leverling',
    RiskLevel: 2,
    Color: '#1F88E5',
    ClassName: 'meeting, high-severity, janet-leverling',
  },
  {
    Id: 'Vuln-004',
    Title: 'Vulnerability - 10004',
    Status: 'InProgress',
    Summary: 'Fix the vulnerabilities reported in the IE browser.',
    Type: 'Bug Fix',
    Severity: 'High',
    Tags: 'Browser',
    Effort: 2.5,
    ...
    RiskLevel: 2,
    Color: '#E64A19',
    ClassName: 'bug-fix, high-severity, janet-leverling',
  },
];
